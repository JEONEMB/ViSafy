...
@Entity
public class ProductDocumentRequirement {
    ...
    protected ProductDocumentRequirement() {}

    public ProductDocumentRequirement(FinancialProduct product, SourceDocument sourceDocument,
                                      String documentName, String description,
                                      DocumentRequirementType requirementType, String conditionRuleKey,
        ...
        this.conditionRuleKey = conditionRuleKey;
    ...
    public DocumentRequirementType getRequirementType() { return requirementType; }
    public String getConditionRuleKey() { return conditionRuleKey; }
