...
| # | 제출물 | 형식 | 제출 위치 | 상태 |
| --- | --- | --- | --- | --- |
| 1 | 공모전 기획서 | 제공 양식 → **PDF 변환** | [제출 탭] - [공모전 기획서 제출] | 양식 필요 |
| 2 | 기능 명세서 | 제공 양식 → **PDF 변환** | [제출 탭] - [MVP 산출물 제출] | 양식 필요 |
...
> 양식 파일을 받아야 1·2번을 채울 수 있다. 양식이 확보되면 [기획서 내용 재료](#기획서-내용-재료)의 문단을 해당 칸에 옮긴다.
