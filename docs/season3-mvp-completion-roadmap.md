...
- Season 3 READY 8개, PARTIAL 2개, NOT_READY 1개와 4개 금융기관 데이터
...
- [x] 11개 상품 전체의 Rule 설명·서류명·신청단계 문구를 6개 언어로 번역 (미번역 0)
...
- [x] 고정 Demo 상품별 대표 질문 5개를 최종 검수
- [x] 질문별 기대 승인 Source ID 지정
- [x] 언어별 Top-K Source 포함률 측정 (6개 언어 모두 1.00)
- [x] 다른 상품 Source 혼입률 측정 (0.00)
- [x] Source 인용 정확성 측정 (0.95)
- [x] 숫자·Visa·금액 무결성 측정 (수정 전 0.77 → 수정 후 **1.00**)
- [x] 비한국어 템플릿 답변에 공식 원문을 함께 인용해 숫자·Visa 코드 누락 해결
- [x] 근거 없는 질문의 안전 차단률 측정 (6개 언어 1.00)
- [x] 결과를 발표자료용 한 장 표로 정리 → `docs/season3-demo-rag-evaluation-2026-08-29.md`
